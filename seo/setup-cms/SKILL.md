...
description: >
  Connect a CMS to mentionstack SEO tools. Guides users through configuring
...
Guide the user through connecting their CMS to mentionstack's SEO analysis tools.
...
>    → enter a name like "mentionstack" → click **Add New** → copy the generated password
>
